...
/* Table: items                                                 */
/*==============================================================*/
insert into items values (1, '筆電', 30000, 'LC170W001', 5,'5A', 'laptop.png', 'erik1110', '2021-01-18', '2021-01-23', '已借出');
insert into items values (2, '筆電', 40000, 'LC170W002', 5,'5A', 'laptop.png', '', '', '', '未借出');
insert into items values (3, '筆電', 50000, 'LC170W003', 5,'12B', 'laptop.png', 'erik1110', '2021-01-18', '2020-01-23', '已借出');
...
insert into items values (11, '投影筆', 170, '', 3,'5A', 'pointer.png', 'penchaq', '2020-01-13', '2020-01-15', '已借出');
/*==============================================================*/
/* Table: records  單據                                         */
/*==============================================================*/
